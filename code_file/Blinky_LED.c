...
/*-----------------------------------------------------Includes------------------------------------------------------*/
/*********************************************************************************************************************/
#include "IfxPort.h" //포트를 정의해주기 위해서
#include "Bsp.h" //waitTime 사용하기 위해서
...
void blinkLED(uint32 wat_time)
{
    IfxPort_togglePin(LED);                                                     /* Toggle the state of the LED      */
    waitTime(IfxStm_getTicksFromMilliseconds(BSP_DEFAULT_TIMER, wat_time));    /* Wait 500 milliseconds            */
}
